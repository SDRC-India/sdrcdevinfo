  ...
  <xsl:template match="/">
                <div class="CodeListView">
                  <div id="reg_content_containers">
                    <caption>
                      <h2>
                         <xsl:value-of select="message:Structure/message:CodeLists/structure:CodeList/structure:Name [@xml:lang='es']"/>
                        </h2>
                        <h5></h5>
                    </caption>
                      ...
                      <div id="reg_wide_sec_ppup">
                        ...
                        <xsl:for-each select="message:Structure/message:CodeLists/structure:CodeList/structure:Code/structure:Description [@xml:lang='es']">
