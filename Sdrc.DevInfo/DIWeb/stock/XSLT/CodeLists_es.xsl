  ...
  <xsl:template match="/">
    <div class="CodeListView">
      <div id="reg_content_containers">
        <caption>
          <h2>
            <xsl:value-of select="message:Structure/message:Structures/structure:Codelists/structure:Codelist/common:Description [@xml:lang='es']"/>
          </h2>
          <h5></h5>
        </caption>
        ...
        <div id="reg_wide_sec_ppup">
          ...
          <xsl:for-each select="message:Structure/message:Structures/structure:Codelists/structure:Codelist/structure:Code/common:Name [@xml:lang='es']">
