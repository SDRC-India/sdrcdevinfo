...
public partial class libraries_aspx_ManageCategories : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            lang_AddNewCategory.InnerHtml = Global.GetLanguageKeyValue("Add");
            lang_EditCategory.InnerHtml = Global.GetLanguageKeyValue("lang_Edit");
            lang_DeleteCategory.InnerHtml = Global.GetLanguageKeyValue("lang_Delete");
            this.GetPostedData();
        }
