<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="libraries_aspx_AboutDevInfo" %>
...
<%--    <h2>Census in India</h2>//TOOK INSIDE TO RESOLVE MULTI VERSION ISSUE FOR HEADING
        <h5></h5>--%>

        <!-- Main Contact Page Content Area ...starts-->
        <div class="desc_pg_main_sec pddn_lft_nne">
            <!-- Iframe for Content of page ...starts-->
            <iframe id="frame_auto" src="About.htm" scrolling="no" frameborder="0"></iframe>
