<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="FactsOfTheWeek.aspx.cs" Inherits="libraries_aspx_FactsOfTheWeek" %>
...
<div class="content_containers">
    <div id="reg_content_containers">
        <h2>Facts of the week</h2>
        <h5></h5>

        <!-- Main Page Content Area ...starts-->
        <div class="desc_pg_main_sec">
            <!-- Iframe for Content of page ...starts-->
            <iframe id="frame_auto" src="FactsOfTheWeek.htm" scrolling="no" frameborder="0"></iframe>
