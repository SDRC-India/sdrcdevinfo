...
public partial class libraries_aspx_News : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string IsVisibleAddNew = string.Empty;
        try
        {
            
            aNews.InnerHtml = Global.GetLanguageKeyValue("News");
            aDIA.InnerHtml = Global.GetLanguageKeyValue("DevInfoinAction");
            aFOW.InnerHtml = Global.GetLanguageKeyValue("FactOTWeek");
    ...
    private void GiveCMSOprtion(string pageName)
    {
        ...
        AddNewNews.Style.Add("display", "none");
        ...
        if (Session[Constants.SessionNames.LoggedAdminUser] != null)
        {
            if (!string.IsNullOrEmpty(Session[Constants.SessionNames.LoggedAdminUser].ToString()))
            {
                ...
                if (pageName.Contains("diorg/di_news") || pageName.Contains("diorg/devinfo_in_action.html"))
                {
