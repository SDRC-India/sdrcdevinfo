<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="DevInfoTeam.aspx.cs" Inherits="libraries_aspx_DevInfoTeam" %>
...
<div class="content_containers">
    <div id="reg_content_containers">
        ...
        <div class="desc_pg_main_sec">
            ...
            <iframe id="frame_auto" src="DevInfoTeam.htm" scrolling="no" frameborder="0"></iframe>
