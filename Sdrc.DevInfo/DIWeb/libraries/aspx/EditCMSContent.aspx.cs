...
public partial class libraries_aspx_EditCMSContent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Request.QueryString["PN"] != null)
            {
                ...
                Relativepath = "../../libraries/aspx/" + PageName;
                if (PageName.Contains("news"))
                {
                    SpnEditContentHeading.InnerText = "Edit News";
                }
                if (PageName.Contains("action"))
                {
                    SpnEditContentHeading.InnerText = "Edit Action";
                }
                if (PageName.Contains("facts"))
                {
                    SpnEditContentHeading.InnerText = "Edit Facts";
                }
                if (PageName.Contains("monitoring"))
                {
                    SpnEditContentHeading.InnerText = "Edit Monitoring";
                }
                if (PageName.Contains("dashboards"))
                {
                    SpnEditContentHeading.InnerText = "Edit Dashboards";
                }
                if (PageName.Contains("innovations"))
                {
                    SpnEditContentHeading.InnerText = "Edit Innovations";
                }
                if (PageName.Contains("about"))
                {
                    SpnEditContentHeading.InnerText = "Edit About Info";
                }
                if (PageName.Contains("Features"))
                {
                    SpnEditContentHeading.InnerText = "Edit Features";
                }
            }
