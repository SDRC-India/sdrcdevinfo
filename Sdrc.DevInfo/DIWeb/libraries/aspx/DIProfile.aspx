<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="DIProfile.aspx.cs" Inherits="libraries_aspx_DIProfile" %>
...
<div class="content_containers">
    <div id="reg_content_containers">
        ...
        <div class="desc_pg_main_sec">
            ...
            <iframe id="frame_auto" src="DIProfile.htm" scrolling="no" frameborder="0"></iframe>
