<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/RegistryMaster.master"
    AutoEventWireup="true" CodeFile="RegUpload.aspx.cs" Inherits="libraries_aspx_RegUpload" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphRegistryMainContent" runat="Server">
    ...
    <script type="text/javascript" src="../js/sdmx/Upload.js?v=<%=Global.js_version%>"></script>
    ...
    <div id="reg_lft_sec" style="width: 100%">
                ...
                <div id="divAddUploadDSD">
                    ...
                    <p class="confg_frm_inp_bx">
                        <select id="selAssosciatedDatabase" class="confg_frm_inp_bx_txt_dd">
                            <option value="0" id="lang_Select_Assosciated_Database">
                                <%--Select Assosciated Database--%></option>
                        </select><br />
                        <br />
                    </p>
                    <p class="confg_frm_txt">
                        ...
                        <br />
                        <span id="lang_Default_DSD_Upload">
                            <%--Default DSD:--%></span><input id="chkDefaultDSDUpload" type="checkbox" />
                        <br />
                        <br />
                    ...
                    <div class="confg_Adm_box">
                        ...
                        <p class="confg_frm_inp_bx">
                            <select id="selAssosciatedDatabaseEditDelete" class="confg_frm_inp_bx_txt_dd">
                                <option value="0" id="lang_Select_Assosciated_Database_Edit_Delete">
                                    <%--Select Assosciated Database--%></option>
                            </select>
                            <br />
                        </p>
                        ...
                        <p class="confg_frm_inp_bx">
                            <select id="selDSD" class="confg_frm_inp_bx_txt_dd">
                                <option value="0" id="lang_Select_DSD">
                                    <%--Select DSD--%></option>
                            </select>
                            <br />
                        </p>
                        <p class="confg_frm_txt">
                            ...
                            <br />
                            <br />
                            <span id="lang_Default_DSD_Update">
                                <%--Default DSD:--%></span><input id="chkDefaultDSDUpdate" type="checkbox" />
                            <br />
                            <br />
        ...
        <div id="DivHeaderPopUp" class="popup_block HeaderPopUp" >

        <div id="DivHeaderContainer" class="HeaderCont" >        
        </div>
    ...
    <input type="hidden" id="lang_Header" value="" />
