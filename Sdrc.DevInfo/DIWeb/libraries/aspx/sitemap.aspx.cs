...
public partial class libraries_aspx_sitemap : System.Web.UI.Page
{
    ...
    {
        string Relativepath = "../../" + Constants.FileName.SitemapHtmlPage;
        ...
        SitemapDataHeader.InnerHtml = ConnectionDetails[1].ToString().Split(new string[] { "||" }, StringSplitOptions.None)[2].ToString();
        Page.MetaDescription = Global.MetaTag_Desc;
        Page.MetaKeywords = Global.MetaTag_Kw;
    }
