...
public partial class libraries_aspx_RegDataProvider : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // Set page title
            Page.Title = Global.adaptation_name + " - Registry - " + Constants.Pages.Registry.DataProvider;
