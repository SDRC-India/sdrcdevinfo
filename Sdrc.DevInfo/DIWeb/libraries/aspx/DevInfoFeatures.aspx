<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master"
    AutoEventWireup="true" CodeFile="DevInfoFeatures.aspx.cs" Inherits="libraries_aspx_DevInfoFeatures" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    <div class="content_containers">
        <div id="reg_content_containers">
                <h2>
                     <span id="langAboutInfoFeatures"></span>
                    <div class="adm_nav_opt pddn_bttm_nne flt_rgt">
                        <ul>
                            <li><a href="javascript:void(0);" id="EditPage" runat="server"></a></li>
                        </ul>
                    </div>
                </h2>
                <div class="clear"></div>
