<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="DevInfoInAction.aspx.cs" Inherits="libraries_aspx_DevInfoInAction" %>
...
<div class="content_containers">
    <div id="reg_content_containers">
        <h2>DevInfo In Action</h2>
        <h5></h5>

        <!-- Main Contact Page Content Area ...starts-->
        <div class="desc_pg_main_sec">
            <!-- Iframe for Content of page ...starts-->
            <iframe id="frame_auto" src="DevInfoInAction.htm" scrolling="no" frameborder="0"></iframe>
