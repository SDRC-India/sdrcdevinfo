<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master" AutoEventWireup="true" CodeFile="AddArticle.aspx.cs" Inherits="libraries_aspx_AddArticle" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="width:300px">
                                        <select id="PageCategory" style="width:100%"><option value="NEWS">News</option><option value="ACTION">DevInfo Action</option><option value="FACTS">Facts</option></select>
                                    </td>
                                </tr>
                            </table>
                        </td>
