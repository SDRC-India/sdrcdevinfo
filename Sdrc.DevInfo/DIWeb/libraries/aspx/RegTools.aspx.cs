...
public partial class libraries_aspx_Tools : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // Set pate title
            Page.Title = Global.adaptation_name + " - Registry - " + Constants.Pages.Registry.Validate;
            ...
            else
            {
                ...
                lblAdaptationName.InnerHtml = Global.adaptation_name;
                lblAdaptationNameComp.InnerHtml = Global.adaptation_name;
