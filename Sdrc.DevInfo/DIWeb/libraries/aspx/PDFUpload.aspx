<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PDFUpload.aspx.cs" Inherits="libraries_aspx_PDFUpload" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function UpdateSourceLinkWindow(fileName, filePath) {            
            ...
            if (displayFileName.indexOf(".pdf") == -1) {
            ...
            window.parent.document.getElementById("hidPDFFileName").value = filePath;
            window.parent.document.getElementById("anchorPDF").href = filePath;
            window.parent.document.getElementById("anchorPDF").innerHTML = displayFileName;
            window.parent.document.getElementById("divSpan").style.display = "";
            window.parent.document.getElementById("divDocument").style.display = "none";


//            if (this.name == "frame1") {
//                UpdateControlForFrames(sec, 4, 3, 4, displayFileName, filePath, fileName);
//            }
//            else if (this.name == "frame2") {
//                UpdateControlForFrames(sec, 4, 6, 6, displayFileName, filePath, fileName);
//            }
//            else if (this.name == "frame3") {
//                UpdateControlForFrames(sec, 4, 9, 8, displayFileName, filePath, fileName);
//            }
//            else if (this.name == "frame4") {
//                UpdateControlForFrames(sec, 4, 12, 10, displayFileName, filePath, fileName);
//            }
//            else if (this.name == "frame5") {
//                UpdateControlForFrames(sec, 4, 15, 12, displayFileName, filePath, fileName);
//            }
        }
...
<body>
    <div>
        <form id="myform" name="myform" runat="Server" action="PDFUpload.aspx" method="POST"
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    ...
                    <div style="height: 140px"><br />
                        <img id="imgNews" runat="server" src="diorg/images/news_images/mexicodash_small.jpg"
                            style="height: 85px; width: 140px" alt="News Image" />
                    </div>
