<%@ Page Title="" Language="C#" MasterPageFile="~/libraries/aspx/HomeMaster.master"
    AutoEventWireup="true" CodeFile="EditCmsContents.aspx.cs" Inherits="libraries_aspx_EditCmsContents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    ...
    <div class="content_containers">
        <div id="reg_content_containers">
            <h2>
                <span id="SpnAddContentHeading" runat="server">Edit Content</span></h2>
            <h5>
            </h5>
        </div>
        <div class="wdth_nnty_fv">
            <div style="float: left; margin-right: 10px; width: 440px">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="text" id="txtTitle" style="width: 430px" maxlength="200" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="fnt_bld fnt_sz_frten">
                    ...
                    <tr>
                        <td colspan="2">
                            <input id="txtTags" runat="server" style="width: 430px" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="width: 100%">
                            <textarea id="txtSummary" rows="5" style="width: 100%" runat="server"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        <td>
                            <div id='tdFileUpload1' name="tdFileUpload1" runat='server' style='height: 150px;
                                vertical-align: top;'>
                                <iframe id='frame1' name='frame1' src="FileUpload.aspx?File=<%=ThumbNailImageSrc %>"
                                    frameborder='0' scrolling='no' height='150px' marginwidth='0px' marginheight='0px'
                                    style="width: 440px"></iframe>
                ...
                <td colspan="2" style="width: 100%">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div id='tdFileUpload2' name="tdFileUpload2" runat='server' style='height: 30px;
                                                                vertical-align: top;'>
                                                                <iframe id='frame2' name='frame2' src="PDFUpload.aspx?Pdf=<%=PdfSrc %>" frameborder='0'
                                                                    scrolling='no' height='23px' marginwidth='0px' marginheight='0px' style="width: 440px">
                                                                </iframe>
                            ...
                            <input type="hidden" id="HdnContentId" value="" runat="server" />
                            <input type="hidden" id="HdnCurrentArticleTagIds" value="" runat="server" />
                            <input type="hidden" id="HdnCurrentArticlePageNo" value="" runat="server" />
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        di_jq(document).ready(function () {
            ...
            di_jq('#BtnOK').click(function () {
                ...
                var PdfSrc = '';
                var TagId = '<%=TagID %>';
                var ContentId = cphMainContent_HdnContentId.value;
                var Title = cphMainContent_txtTitle.value;
                var Date = di_jq("#datepicker").val();
                var Summary = cphMainContent_txtSummary.value;
                if (hidImgPath.value == "") {
                    ImageSrc = '<%=ThumbNailImageSrc %>';
                }
                else {
                    ImageSrc = hidImgPath.value;
                }
                var DetailedContent = CKEDITOR.instances.editorCMS.getData();
//                if (hidPDFFileName.value == "") {
//                    PdfSrc = '<%=PdfSrc %>';
//                }
//                else {
                    PdfSrc = hidPDFFileName.value;
//                }

                var PCategory = PageCategory.value;
                var Tags = cphMainContent_txtTags.value;
                if (Title == "") {
...
//                    }
                    ...
                    InputParam += ParamDelimiter + TagId;
                    InputParam += ParamDelimiter + cphMainContent_HdnCurrentArticlePageNo.value;
                    InputParam += ParamDelimiter + cphMainContent_HdnCurrentArticleTagIds.value;
                    di_jq.ajax({
                        type: "POST",
                        url: CallbackPageName,
                        data: { 'callback': '1023', 'param1': InputParam },
                        async: true,
                        beforeSend: function () {
                            ApplyMaskingDiv();
                        },
        ...
        SetDetaildContent();
        function SetDetaildContent() {
            var data = '<%=DetaildContent.ToString().Replace("\'","&quot;") %>';
            CKEDITOR.instances.editorCMS.setData(data);
            di_jq("#datepicker").val('<%=EditDatetime %>');
        }
    </script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        createFormHiddenInputs("frmEditCMSContents", "POST");
        SetCommonLinksHref("frmEditCMSContents", "POST");
