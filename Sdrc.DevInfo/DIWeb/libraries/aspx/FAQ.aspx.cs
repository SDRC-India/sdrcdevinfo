...
public partial class libraries_aspx_FAQ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            aGeneralFAQ.InnerHtml = Global.GetLanguageKeyValue("GeneralFAQ");
            aApplicationSpecificFAQ.InnerHtml = Global.GetLanguageKeyValue("AppSpecificFAQ");
            if (Request.QueryString["T"].ToString() == "A")
            {
                Header.InnerHtml = Global.GetLanguageKeyValue("GeneralFAQ");
                Desc.InnerHtml = Global.GetLanguageKeyValue("GeneralFAQDesc");
            }
            else
            {
                Header.InnerHtml = Global.GetLanguageKeyValue("AppSpecificFAQ");
                Desc.InnerHtml = Global.GetLanguageKeyValue("AppSpecificFAQDesc");
            }
    ...
    private void GiveCMSOprtion(string pageName)
    {
        ...
        AddNewFAQ.Style.Add("display", "none");
