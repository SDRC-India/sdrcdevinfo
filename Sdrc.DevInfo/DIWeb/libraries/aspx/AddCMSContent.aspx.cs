...
public partial class libraries_aspx_AddCMSContent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (Request.QueryString["PN"] != null)
            {
                ...
                RequestingPagePath = "../../libraries/aspx/" + PageName;

                if (RequestingPagePath.Contains("news"))
                {
                    SpnAddContentHeading.InnerText = "Add News";
                }
                if (RequestingPagePath.Contains("action"))
                {
                    SpnAddContentHeading.InnerText = "Add Action";
                }
            }
        }
        GetPostedData();
