    ...
    Chosen = (function (_super) {
        ...
        _this = this;
         ...
         style: 'width: ' + (this.options.width || this.f_width + 'px;')
            ...
            if (this.is_multiple) {
            //style="width:100%" added
            //removed width:25px; 
                container_div.html('<ul class="chzn-choices"><li class="search-field" style="width:100%"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:100%;" /></li></ul><div class="chzn-drop" style="left:-9000px; display: none;"><ul class="chzn-results"></ul></div>');
            } else {
