...
var CommaSeparator = ",";
var ArtifactsGeneratedSuccessfully = '';
var MsgErrorOccurred = '';
var UploadedSuccessfully = '';
var ErrorWhileUploading = '';
var UpdatedSuccessfully = '';
var ErrorWhileUpdating = '';
var DeletedSuccessfully = '';
var ErrorWhileDeleting = '';
var ArtifactNotFound = '';
var SameVersionUploaded = '';
var SelectAssociatedDatabase = '';
...
function onPageLoad(hdsby, hdbnid, hselarea, hselind, hlngcode, hlngcodedb, hselindo, hselareao, hLoggedInUserNId, hLoggedInUserName, hOriginaldbnid) {
    ...
    // ************************************************
    createFormHiddenInputs("frm_sdmxDatabaseManagement", "POST");
    SetCommonLinksHref("frm_sdmxDatabaseManagement", "POST");
    SetOriginaldbnidInForm("frm_sdmxDatabaseManagement", hOriginaldbnid);
    ...
    SetCommonRegistryPageDetails('RegDatabaseManagement.aspx', "frm_sdmxDatabaseManagement", "POST");
    LanguageHandlingForAlerts();
 
}

function LanguageHandlingForAlerts() {
    ArtifactsGeneratedSuccessfully = document.getElementById('hArtifactsGeneratedSuccessfully').value;
    UploadedSuccessfully = document.getElementById('hUploadedSuccessfully').value;
   // MsgErrorOccurred = document.getElementById('hErrorOccurred').value;
    ErrorWhileUploading = document.getElementById('hErrorWhileUploading').value;
    UpdatedSuccessfully = document.getElementById('hUpdatedSuccessfully').value;
    ErrorWhileUpdating = document.getElementById('hErrorWhileUpdating').value;
    DeletedSuccessfully = document.getElementById('hDeletedSuccessfully').value;
    ErrorWhileDeleting = document.getElementById('hErrorWhileDeleting').value;
    ArtifactNotFound = document.getElementById('hArtifactsNotFound').value;
    SameVersionUploaded = document.getElementById('hSameVersionUploaded').value;
    SelectAssociatedDatabase = document.getElementById('hSelectAssociatedDatabase').value;
}
...
function GenerateSDMXArtefacts() {
    try {
        ...
        InputParam = document.getElementById('hdbnid').value; // DbId;
        ...
        di_jq.ajax({
            ...
            success: function (data) {
                try {
                    ...
                    if (data == "true") {
                        HideLoadingDiv();
                        // alert("SDMX artifacts generated successfully for selected database.");
                       ArtifactsGeneratedSuccessfully= document.getElementById('hArtifactsGeneratedSuccessfully').value
                        alert(ArtifactsGeneratedSuccessfully);
            ...
            success: function (data) {
                try {
                    if (data == "True") {
                        ...
                        alert(ErrorWhileUploading + " " + data);
                    }
                    HideUploadDSDPopup();
                    RemoveLoaderNMask();
                }
        ...
        di_jq.ajax({
            ...
            success: function (data) {
                try {
                    ...
                    if (parseInt(document.getElementById('hdbnid').value) != parseInt(document.getElementById('hOriginaldbnid').value)) {
                         di_jq("#btnGenerateSDMXArtefacts").attr("disabled",true);
                    }
                    else {

                        di_jq("#btnGenerateSDMXArtefacts").removeAttr("disabled");
                    }
                }
                catch (ex) {
                    //    alert("Error : " + ex.message);
    ...
    if (CheckIfDSDAlreadyUploaded(FileNameWPath)) {
        if (action == 'A')//Add
        {
            if (z("selAssosciatedDatabase").selectedIndex <= 0) {
                ...
                alert(SelectAssociatedDatabase);
