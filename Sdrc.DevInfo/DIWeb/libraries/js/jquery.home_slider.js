...
(function ($) {
    ...
    $.anythingSlider = function (el, options) {
        ...
        base.init = function () {
            ...
            base.$startStop = $('<a href="#" class="start-stop" id="pp_bttn"></a>');
            if (o.buildStartStop) {
                base.$startStop.appendTo((o.appendStartStopTo !== null && $(o.appendStartStopTo).length) ? $(o.appendStartStopTo) : base.$controls);
            }
            base.$nav = $('<ul class="thumbNav" id="thumbNav" />').appendTo((o.appendNavigationTo !== null && $(o.appendNavigationTo).length) ? $(o.appendNavigationTo) : base.$controls);
...
//                base.width = 889;
//				base.$el.closest('div.anythingWindow').css("float", "right");
//                base.$el.closest('div.anythingWindow').width(889);
//            }
//            else {
                base.width = base.$el.width() + 45;
            //}
            ...
            if (o.buildNavigation && (base.pages > 1)) {
                ...
                base.$items.filter(':not(.cloned)').each(function (i) {
                    ...
                    if ($.isFunction(o.navigationFormatter)) {
                        ...
                        $a.html('<span>' + t + '<img src="../../stock/themes/default/images/spacer.gif" width="11" height="11" /></span>');
                        // Add formatting to title attribute if text is hidden
                        if (parseInt($a.find('span').css('text-indent'), 10) < 0) { $a.addClass(o.tooltipClass).attr('title', t); }
                    } else {
                        $a.html('<span>' + index + '<img src="../../stock/themes/default/images/spacer.gif" width="11" height="11" /></span>');
                    }
        ...
        base.buildNextBackButtons = function () {
            //base.$forward = $('<span class="arrow forward"><a href="#"><span>' + o.forwardText + '</span></a></span>'); -- UPDATED TO RESOLVE "RTL" ISSUE
            //base.$back = $('<span class="arrow back"><a href="#"><span>' + o.backText + '</span></a></span>'); -- UPDATED TO RESOLVE "RTL" ISSUE

			 var abstyle = '';
			 var afstyle = '';
//			 if (screen.width == 1024) {
//                abstyle = 'style="left:-20px;"';
//				afstyle = 'style="right:-26px;"';
//            }
            
            base.$forward = $('<span class="arrow forward" '+afstyle+'><a href="#"></a></span>');
            base.$back = $('<span class="arrow back" '+abstyle+'><a href="#"></a></span>');
