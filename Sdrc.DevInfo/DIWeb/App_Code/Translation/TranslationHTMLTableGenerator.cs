...
/// <summary>
/// Summary description for TranslationHTMLTableGenerator
/// </summary>
public class TranslationHTMLTableGenerator
{
    #region "-- Inner Class --"
    ...
    public class CssClassName
    {
        ...
        private string _CheckBoxDataColumn = "CheckBoxDataColumnStyle";
        /// <summary>
        ...
        private string _FirstDataColumn = "DataColumnStyle";
        /// <summary>
        ...
        private string _DataColumn = "DataColumnStyle";
        /// <summary>
        ...
        private string _HeaderColumn = "HeaderColumnStyle";
        /// <summary>
        ...
        private string _CheckBoxColumn = "CheckBoxColumnStyle";
        /// <summary>
    ...
    public TranslationHTMLTableGenerator()
    {
        //
    ...
    public string GetTableRow(DataRow row, string IDPrefix, string NIdColumnName)
    {
        ...
        foreach (DataColumn Column in row.Table.Columns)
        {
            if (Column.ColumnName.ToUpper() != NIdColumnName.ToUpper())
            {
                StrBuilder.AppendLine(this.GetTableRowColumn(row, Column.ColumnName, Column.Ordinal, CssName));
            }
        }
    ...
    /// <returns></returns>
    public string GetTableRowColumn(DataRow row, string columnName, int columnOrdinal, string cssName)
    {
        string RetVal = string.Empty;
        ...
        if (columnOrdinal==2)
        {
            StrBuilder.Append("<TD id='" + row[0].ToString() + "' class='" + cssName + "' onclick='ShowTextboxForEnterTargetValue(this,event);' style='padding-left:5px;' >");           
        }
        else
        {
            StrBuilder.Append("<TD class='" + cssName + "' style='width:50%; padding-left:5px;' >");
        }
