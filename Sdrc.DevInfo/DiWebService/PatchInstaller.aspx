...
<head runat="server">
    ...
    <script type="text/javascript" src="js/browsr_selector.js"></script>
</head>
<body>
    ...
    <div class="content_containers">
        ...
        <div id="rgt_sec_adm"><br />
            <h1 id="lang_db_PatchMainHeading" runat="server">
                <!-- Patch Settings-->
            </h1>
            <h4 id="lang_db_Patch_subHead" runat="server"></h4>
            ...
            <div class="adm_upd_bttn pddn_tp_fftn">
                <input type="button" id="BtnInstall_Patch" value="" onclick="InstallPatch(LogFilePath);" runat="server"
                    class="di_gui_button lng_bttn_sz" />
            </div>
            <div class="clear">
            </div>
        </div>
