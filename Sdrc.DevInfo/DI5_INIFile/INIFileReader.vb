...
Enum IniItemTypeEnum
   ...
   GetKeysAndValues = 2
End Enum
Public Class DI5_IniFileReaderNotInitializedException
...
Public Class DI5_IniFileReader
    ...
    Public ReadOnly Property IniFilename() As String
        Get
            If Not Initialized Then Throw New DI5_IniFileReaderNotInitializedException
    ...
    Public Function SetIniSection(ByVal oldSection As String, ByVal newSection As String) As Boolean
        ...
        If Not Initialized Then
            Throw New DI5_IniFileReaderNotInitializedException
        End If
