...
namespace DevInfo.Lib.DI_LibBAL.UI.Presentations.DIExcelWrapper
{
    ...
    internal class ExcelHelper
    {
        ...
        private static string GetNumberFormat(bool isDecimalValue, int decimalPlaces, bool isGroupingRequired, double value)
        {
            ...
            try
            {
                ...
                {
                    Retval = "#" + Utility.DICommon.NumberGroupSeparator + "##0";
                }
                else
                {
                    Retval = "###0";
                ...
                {
                    if (value.ToString().Contains(Utility.DICommon.NumberDecimalSeparator))
                    {
