...
namespace DevInfo.Lib.DI_LibBAL.Controls.LookInWindowBAL
{
    ...
    /// </summary>
    public class MetaDataCategoryIndicatorLookInSource : BaseLookInSource
    {

        #region"-- Private --"

        private MetadataElementType MDElementType = MetadataElementType.Indicator;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        foreach (string CategoryNId in SelectedNids)
                        {
                           ...
                           // MDCatInfo.CategoryType = DIQueries.MetadataElementTypeText[this.MDElementType]; 
