...
{
    //public class SubgroupOthersLookInSource : BaseLookInSource
    //{
    //    #region"--Protected--"
    ...
    //        FilterString = Subgroup.SubgroupType + " = " + Convert.ToInt32(SubgroupType.Others);
    ...
    //                SourceDBSubgroup.Type = SubgroupType.Others;
    ...
    //    {
    //        this.Columns.Clear();
    //        this.Columns.Add(Subgroup.SubgroupName, DILanguage.GetLanguageString(Constants.LanguageKeys.Subgroupothers));
