...
//    /// </summary>
//    public class SubgroupSexLookInSource : BaseLookInSource
//    {
//        #region"--Protected--"
...
//            FilterString = Subgroup.SubgroupType + " = " + Convert.ToInt32(SubgroupType.Sex);
...
//                  SourceDBSubgroup.Type = SubgroupType.Sex;
...
//        {
//            this.Columns.Clear();
//            this.Columns.Add(Subgroup.SubgroupName, DILanguage.GetLanguageString(Constants.LanguageKeys.SubgroupSex));
