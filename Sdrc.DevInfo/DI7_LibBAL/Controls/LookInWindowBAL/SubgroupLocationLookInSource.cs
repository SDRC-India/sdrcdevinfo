...
{
   //public class SubgroupLocationLookInSource : BaseLookInSource
   // {
   //     #region"--Protected--"
   ...
   //         FilterString = Subgroup.SubgroupType + " = " + Convert.ToInt32(SubgroupType.Location);
   ...
   //                SourceDBSubgroup.Type = SubgroupType.Location;
   ...
   //    {
   //        this.Columns.Clear();
   //        this.Columns.Add(Subgroup.SubgroupName, DILanguage.GetLanguageString(Constants.LanguageKeys.SubgroupLocation));
