...
namespace DevInfo.Lib.DI_LibBAL.Utility
{
    ...
    /// As long as encryption and decryption routines use the same parameters (private constants) to generate the keys, the keys are guaranteed to be the same.
    /// </summary>
    /// <remarks>
    ...
    public class Encryption
    {
        ...
        /// <summary>
        /// Hash algorithm used to generate password. Allowed values are: "MD5" and "SHA1".
